#from gestor_datos import Gestor_datos, Visualizacion
...
if __name__ == "__main__":
    ...
    thread1 = my_thread(1, "iol", iol.scraper_iol, "cedear")
    #thread2 = my_thread(2, "ON", gestor_datos.grabar_cot_ON)
    thread3 = my_thread(3, "iol2", iol.scraper_iol, "bond")

    thread1.start()
    # thread2.start()
    thread3.start()
    thread1.join(
    )  # esperamos que thread termine de ejecutar para finalizar programa
    # thread2.join()
    thread3.join()
